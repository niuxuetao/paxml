...
/**
 * Tag that verifies the value (label) of an element.
 * 
 * @author Xuetao Niu
 * 
 */

public abstract class AssertElementTag extends SelectableTag {

    @Override
    final protected Object onCommand(Context context) {

        handleElements(new IElementHandler() {
    ...
    protected abstract void doAssertion(WebElement ele);
